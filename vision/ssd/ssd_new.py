...
class SSD(nn.Module):
    def __init__(
        self,
        num_classes: int,
        base_net1: nn.ModuleList,
        base_net2: nn.ModuleList,
        ...
        self.base_net1 = torch.nn.Sequential(*base_net1)
        self.base_net2 = torch.nn.Sequential(*base_net2)
    ...
    def forward(self, x: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        y = self.source_layer_indexes[0][1](x)
